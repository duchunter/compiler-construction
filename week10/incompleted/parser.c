...
Type* compileLValue(void) {
  // TODO: parse a lvalue (a variable, an array element, a parameter, the current function identifier) - Done
  Object* var;
  Type* varType;
...
void compileAssignSt(void) {
  // TODO: parse the assignment and check type consistency - Done
...
void compileForSt(void) {
  // TODO: Check type consistency of FOR's variable - Done
  eat(KW_FOR);
  eat(TK_IDENT);
...
void compileArgument(Object* param) {
  // TODO: parse an argument, and check type consistency - Done
...
void compileArguments(ObjectNode* paramList) {
  // TODO: parse a list of arguments, check the consistency of the arguments and the given parameters - Done
  switch (lookAhead->tokenType) {
  case SB_LPAR:
    // No param required
    if (paramList == NULL) {
...
void compileCondition(void) {
  // TODO: check the type consistency of LHS and RSH, check the basic type - Done
  Type *type = compileExpression();
...
Type* compileFactor(void) {
  // TODO: parse a factor and return the factor's type - Done
...
Type* compileIndexes(Type* arrayType) {
  // TODO: parse a sequence of indexes, check the consistency to the arrayType, and return the element type - Done
